...
//  If you want a practical exercise in your existing project (e.g. your card grid):
//  • Select all .card elements.
//  • For each card:
//      • Add an attribute data-index with its index.
//      • Add a class .card--even to even indices (0, 2, 4, ...).
//      • Change the text of an inner element (e.g. .card-title) to include the index.
